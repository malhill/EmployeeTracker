...
INSERT INTO department (dep_name) VALUES ('Software Developer'),('HR'),('Management');
INSERT INTO role (title, salary, dep_id) VALUES ('Full Stack Developer', 100000, 1),('Backend Developer', 100000, 1),('Executive', 75000, 3);
INSERT INTO employee (first_name, last_name, role_id) VALUES ('Billy', 'D. Williams', 1),('Batman', 'Dark Knight', '2'),('Duke', 'Nukem', 3);